...
const GcModal = ({ chatName, users, groupAdmin, _id, setgcProfile }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://blabber-app.onrender.com/api/users/?search=${gcUserSearch}`,
        {
          headers: {
  ...
  const ClickHandler = async () => {
    ...
    const response = await axios.put(
      "https://blabber-app.onrender.com/api/chat/rename",
      formdata,
  ...
  const removeUsers = async (userid, updatedusers, grpAdmin) => {
    ...
    const formdata = JSON.stringify(data);
    const response = await axios.put(
      "https://blabber-app.onrender.com/api/chat/groupremove",
      formdata,
      {
        headers: {
          "Content-Type": "application/json",
  ...
  const addUser = async (id) => {
    ...
    console.log(formdata);
    const response = await axios.put(
      "https://blabber-app.onrender.com/api/chat/groupadd",
      formdata,
      {
        headers: {
          "Content-Type": "application/json",
